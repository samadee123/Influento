...
class AcceptedCampaigns extends StatefulWidget {
  const AcceptedCampaigns({super.key});

  @override
  State<AcceptedCampaigns> createState() => _AcceptedCampaignsState();
}

class _AcceptedCampaignsState extends State<AcceptedCampaigns> {
  List<Map<String, dynamic>> orders = [];
  bool loadingError = false;

  String jsonFile = 'lib/json/accepted_campaign.json';
